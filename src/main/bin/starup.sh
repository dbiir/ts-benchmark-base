...
BINDING_LINE=$(grep "^$2:" "$RUCTS_HOME/bin/bindings.properties" -m 1)
...
echo "===================================================="
"$JAVA_HOME/bin/java" $JAVA_OPTS -classpath "$CLASSPATH" $RUCTS_CLASS $RUCTS_COMMAND -db $BINDING_CLASS $RUCTS_ARGS
echo "===================================================="
